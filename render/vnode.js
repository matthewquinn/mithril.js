...
function Vnode(tag, key, attrs, children, text, dom, domSize) {
	return {tag: tag, key: key, attrs: attrs, children: children, text: text, dom: dom, is: undefined, domSize, state: undefined, events: undefined, instance: undefined}
}
