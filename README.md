...
A modern client-side JavaScript framework for building Single Page Applications. It's small (<!-- size -->6.34 KB<!-- /size --> gzipped), fast and provides routing and XHR utilities out of the box.
